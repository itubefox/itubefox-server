        ...
        axios.get(req.body.url).then(function (response) {
            itubefox(response, function (data) {
                ...
                if (is_cipher(data)) {
                    ...
                    obj_final.url = encodeURIComponent(data.args.player_response.streamingData.adaptiveFormats[(data.args.player_response.streamingData.adaptiveFormats.length - 1)].cipher.url);
                } else {

                    obj_final.url = encodeURIComponent(data.args.player_response.streamingData.adaptiveFormats[(data.args.player_response.streamingData.adaptiveFormats.length - 1)].url);
                }
        ...
        axios.get(req.body.url).then(function (response) {
            itubefox(response, function (data) {
                ...
                if (is_cipher(data)) {
                    ...
                    obj_final.url = encodeURIComponent(data.args.player_response.streamingData.formats[(data.args.player_response.streamingData.formats.length - 1)].cipher.url);
                } else {

                    obj_final.url = encodeURIComponent(data.args.player_response.streamingData.formats[(data.args.player_response.streamingData.formats.length - 1)].url);
                }
